...
subprojects {
    ...
    aliucord {
        author("OmegaSunkey", 9366)
        updateUrl.set("https://raw.githubusercontent.com/OmegaSunkey/awesomeplugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/OmegaSunkey/awesomeplugins/builds/%s.zip")
    }
    ...
    dependencies {
        ...
        implementation("com.aliucord:gradle:main-SNAPSHOT")
